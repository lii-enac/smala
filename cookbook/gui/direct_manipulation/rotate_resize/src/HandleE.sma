...
_define_
HandleE (Component frame, Component target, double size) {
    ...
    FSM resizingFsm {
        ...
        State pressed {
            ...
            0 :: transforms.rightScaleBy.cx
            rect.height /2 :: transforms.rightScaleBy.cy
