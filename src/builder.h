...
namespace Smala {
  ...
  public:
    ...
    virtual ~Builder () {};
    virtual int build (const Ast &ast, const std::string &builddir, const std::string &prefix, bool debug, bool cleaner=false, bool fastcomp=false, bool rmt=false) = 0;
  ...
  protected:
    ...
    virtual void print_type (std::ostream &os, parameter_t type, ExprNode* arg = 0) = 0;
