...
namespace Smala
{
  ...
  public:
    ...
    NativeExpressionNode (std::vector<Node*> expression, bool paused, bool is_connector, bool is_model = true);
    virtual ~NativeExpressionNode ();
    void add_output_node (const std::string &output_node);
    std::vector<Node*> get_expression ();
