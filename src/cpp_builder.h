...
namespace Smala {
  ...
  public:
    ...
    int build (const Ast &ast, const std::string &builddir, const std::string &prefix, bool debug, bool cleaner, bool fastcomp, bool rmt) override;
  private:
    ...
    void print_type (std::ostream &os, parameter_t type, ExprNode* arg = 0) override;
