...
*    Ecole Nationale de l'Aviation Civile, France (2022-2026)
...
_define_
MyBox (Process manager, int _x, int _y) {
  String title ("Title")
  ...
  Switch sw_mode (idle) {
    ...
    Component search_target {
      r.enter->add_arrow
      border.enter->add_arrow
    }
  }
  manager.fsm_mode.state =:> sw_mode.state
}
