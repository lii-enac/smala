...
_define_
HandleN (Component frame, Component target, double size) {
    ...
    FSM resizingFsm {
        ...
        State pressed {
            ...
            rect.width / 2 :: transforms.rightScaleBy.cx
            rect.height :: transforms.rightScaleBy.cy
        ...
        State resizing {
            ...
            //1 :: transforms.rightScaleBy.sx
            Double sy (1)
            1 + (y0 - y1) / rect.height => sy
